# Docker搭建Rclone-WebGui


来源：https://github.com/romancin/rclonebrowser-docker
...
[img](https://images.microbadger.com/badges/version/romancin/rclonebrowser.svg)
[img](https://images.microbadger.com/badges/image/romancin/rclonebrowser.svg)
...
- Map a local volume to /config Storesconfigurationdata
- Map a local volume to /media Accessmediafiles
...
variables can be passed via the `-e` parameter oneforeachvariable. Value
of this parameter has the format `<VARIABLE_NAME>=<VALUE>`.

| Variable            | Description                                                  | Default   |
| :------------------ | :----------------------------------------------------------- | :-------- |
| `USER_ID`           | ID of the user the application runs as. See [User/Group IDs](http://www.baidu.com/archives/38/#usergroup-ids) to better understand when this should be set. | `1000`    |
| `GROUP_ID`          | ID of the group the application runs as. See [User/Group IDs](http://www.baidu.com/archives/38/#usergroup-ids) to better understand when this should be set. | `1000`    |
...
| `DISPLAY_WIDTH`     | Width inpixels of the application's window.                  | `1280`    |
